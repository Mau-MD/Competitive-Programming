...
static const char* interfaces[] = {
	"Main", "ColaInteractivo"
};
static const char* pipeNames[] = {
	"./ColaInteractivo_in", "./ColaInteractivo_out"
};
static char* const commands[][2] = {
	{ "libinteractive/Main/Main", NULL },
	{ "libinteractive/ColaInteractivo/ColaInteractivo", NULL },
};
static char* const debug_commands[][4] = {
	{ "libinteractive/Main/Main", NULL, NULL, NULL },
	{ "/usr/bin/gdbserver", "127.0.0.1:8042", "libinteractive/ColaInteractivo/ColaInteractivo_debug", NULL },
};
