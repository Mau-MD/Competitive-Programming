...
/*
 * Esta funcion me asignara el nodo el grupo el cual el nodo pertenece a un arreglo
*/
int findGroup(int i) {
    if (group[i] == i) { // Si la arista pertenece a si misma
        return i;
    }
